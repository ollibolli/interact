...
$tmpBase_url_sufix = explode('filemanager/', $_SERVER['PHP_SELF']);
$base_url_sufix = str_replace(basename(__FILE__), '', $_SERVER['PHP_SELF']);
//------------------------------------------------------------------------------
...
$upload_dir = '/content/uploads/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../content/uploads/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../content/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
//--------------------------------------------------------------------------------------------------------
